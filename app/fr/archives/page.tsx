        ...
        articles.map((article) => (
          ...
          >
            ...
            <div style={{ marginTop: 16 }}>
              <button
                onClick={() => {
                  const title = isFrench ? article.title_fr : article.title_en;
                  const content = isFrench ? article.content_fr : article.content_en;
                  shareArticle(title, `${content}\n\nTrouvé sur 1gooodnews.app`, 'https://1gooodnews.app');
                }}
                style={{
