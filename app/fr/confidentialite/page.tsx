...
export default function Confidentialite() {
  return (
    <main style={{ padding: '2rem', maxWidth: '700px', margin: '0 auto' }}>
      <h1>🇫🇷 Politique de confidentialité – 1GooodNews</h1>
      <p><strong>Dernière mise à jour :</strong> 20 décembre 2025</p>

      <p>
        L’application 1GooodNews – 1 Bonne Nouvelle par Jour a été conçue pour offrir une expérience simple,
        positive et respectueuse de la vie privée.
      </p>
